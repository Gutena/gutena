<?php
/**
 * Gutena block pattern:  Call to action with background color, pattern, icon, text and button
 */
return array(
	'title'      => __( 'Call to action with background color, pattern, icon, text and button', 'gutena' ),
	'categories' => array( 'gutena-cta' ),
	'content'    => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}},"backgroundColor":"senary"} -->
    ...
    <figure class="wp-block-image size-large"><img src="' . GUTENA_THEME_URI . '/assets/img/icons/logo-big.svg" alt="'. esc_html__( 'logo', 'gutena' ).'" class="wp-image-33"/></figure>
    <!-- /wp:image --></div>
    <!-- /wp:group --></div>
    <!-- /wp:column -->
    ...
    <h2 class="has-text-align-left has-white-color has-text-color has-medium-large-font-size">'. esc_html__( 'Gutena is a Blockbased WordPress theme', 'gutena' ).'.</h2>
    <!-- /wp:heading --></div>
    <!-- /wp:group --></div>
    <!-- /wp:column --></div>
    <!-- /wp:columns --></div>
