...
return array(
    ...
    <div class="wp-block-group alignwide gutena-pattern"><!-- wp:columns {"style":{"spacing":{"padding":{"top":"40px","bottom":"70px","right":"20px","left":"20px"},"blockGap":"50px"}}} -->
    ...
    <div class="wp-block-column" style="flex-basis:40%"><!-- wp:group {"style":{"spacing":{"blockGap":"10px"}}} -->
    ...
    <!-- wp:column {"width":"20%"} -->
    <div class="wp-block-column" style="flex-basis:20%"><!-- wp:group {"style":{"spacing":{"blockGap":"10px"}}} -->
    <div class="wp-block-group"><!-- wp:heading {"level":5} -->
