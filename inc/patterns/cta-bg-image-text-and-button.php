...
return array(
    ...
    <div class="wp-block-group alignfull gutena-pattern"><!-- wp:cover {"url":"' . GUTENA_THEME_URI . '/assets/img/common/CTA.png","id":2400,"dimRatio":40,"overlayColor":"secondary","style":{"spacing":{"padding":{"top":"80px","bottom":"90px","right":"20px","left":"20px"}}}} -->
    <div class="wp-block-cover" style="padding-top:80px;padding-right:20px;padding-bottom:90px;padding-left:20px"><span aria-hidden="true" class="wp-block-cover__background has-secondary-background-color has-background-dim-40 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-2400" alt="" src="' . GUTENA_THEME_URI . '/assets/img/common/CTA.png" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"layout":{"wideSize":"534px"}} -->
