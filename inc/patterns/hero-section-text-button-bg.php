...
return array(
    ...
    <div class="wp-block-group alignfull gutena-pattern"><!-- wp:cover {"url":"' . GUTENA_THEME_URI . '/assets/img/common/Hero-img.jpg","id":2403,"dimRatio":30,"overlayColor":"secondary","isDark":false} -->
    <div class="wp-block-cover is-light"><span aria-hidden="true" class="wp-block-cover__background has-secondary-background-color has-background-dim-30 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-2403" alt="Hero" src="' . GUTENA_THEME_URI . '/assets/img/common/Hero-img.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"spacing":{"padding":{"top":"100px"}}},"layout":{"inherit":false,"wideSize":"735px"}} -->
