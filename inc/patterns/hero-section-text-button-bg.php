...
return array(
    ...
    <div class="wp-block-group alignfull gutena-pattern"><!-- wp:cover {"url":"' . GUTENA_THEME_URI . '/assets/img/common/Hero-img.jpg","id":2403,"dimRatio":70,"overlayColor":"secondary","isDark":false} -->
    <div class="wp-block-cover is-light"><span aria-hidden="true" class="wp-block-cover__background has-secondary-background-color has-background-dim-70 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-2403" alt="Hero" src="' . GUTENA_THEME_URI . '/assets/img/common/Hero-img.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container"><!-- wp:group {"style":{"spacing":{"padding":{"top":"120px"}}},"layout":{"inherit":false,"wideSize":"735px"}} -->
    <div class="wp-block-group" style="padding-top:120px"><!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}},"typography":{"lineHeight":"1.2","fontStyle":"normal","fontWeight":"700"}},"textColor":"white","fontSize":"huge"} -->
