<?php
/**
 * Gutena block pattern:Grid posts
 */
return array(
	'title'      => __( 'Posts in grid layout', 'gutena' ),
	'categories' => array( 'gutena-query','gutena-pages' ),
	'blockTypes' => array( 'core/query' ),
	'content'    => '<!-- wp:query {"query":{"perPage":"6","pages":"3","offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false},"displayLayout":{"type":"flex","columns":2}} -->
    <div class="wp-block-query"><!-- wp:post-template -->
        ...
        <!-- wp:query-no-results -->
        <!-- wp:paragraph {"placeholder":"'.esc_html__( 'Add text or blocks that will display when the query returns no results', 'gutena' ).'."} -->
        <p></p>
        <!-- /wp:paragraph -->
