...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"90px","bottom":"100px","right":"20px","left":"20px"}}},"backgroundColor":"quaternary","className":"gutena-pattern","layout":{"inherit":true}} -->
    <div class="wp-block-group alignfull gutena-pattern has-quaternary-background-color has-background" style="padding-top:90px;padding-right:20px;padding-bottom:100px;padding-left:20px"><!-- wp:group {"align":"wide","layout":{"inherit":false,"wideSize":"730px"}} -->
    ...
    <!-- wp:cover {"url":"' . GUTENA_THEME_URI . '/assets/img/common/video-img-min.jpg","id":2375,"dimRatio":30,"overlayColor":"secondary","isDark":false,"align":"wide"} -->
    <div class="wp-block-cover alignwide is-light"><span aria-hidden="true" class="wp-block-cover__background has-secondary-background-color has-background-dim-30 has-background-dim"></span><img class="wp-block-cover__image-background wp-image-2375" alt="" src="' . GUTENA_THEME_URI . '/assets/img/common/video-img-min.jpg" data-object-fit="cover"/><div class="wp-block-cover__inner-container">
    <!-- wp:group -->
    <div class="wp-block-group">
    <!-- wp:image {"align":"center","id":1597,"sizeSlug":"large","linkDestination":"custom","className":"no-hover-color"} -->
