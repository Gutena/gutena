...
return array(
    ...
    <div class="wp-block-buttons" style="margin-top:37px"><!-- wp:button {"style":{"border":{"radius":"0px"},"typography":{"fontSize":"16px"},"spacing":{"padding":{"top":"13px","bottom":"13px","left":"27px","right":"27px"}}}} -->
