...
return array(
    ...
    <div class="wp-block-group alignwide gutena-pattern" style="padding-top:100px;padding-bottom:100px"><!-- wp:group {"style":{"spacing":{"padding":{"right":"20px","left":"20px","bottom":"70px"}}},"layout":{"wideSize":"540px"}} -->
    <div class="wp-block-group" style="padding-right:20px;padding-left:20px;padding-bottom:70px"><!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"bottom":"5px"}}}} -->
...
<!-- /wp:spacer -->
    ...
    <!-- wp:group {"align":"full","style":{"color":{"background":"#ebf3ff"},"spacing":{"padding":{"top":"100px","right":"20px","bottom":"100px","left":"20px"}}},"className":"gutena-pattern","layout":{"inherit":true}} -->
