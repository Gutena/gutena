...
return array(
	...
	'content'    => '<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"100px","bottom":"90px"}}},"backgroundColor":"quaternary","className":"gutena-pattern","layout":{"inherit":true}} -->
    <div class="wp-block-group alignfull gutena-pattern has-quaternary-background-color has-background" style="padding-top:100px;padding-bottom:90px"><!-- wp:group {"align":"wide"} -->
    ...
    <h6 class="has-primary-color has-text-color has-small-font-size" id="why-choose-us-1" style="margin-top:25px;margin-bottom:10px;font-style:normal;font-weight:700;letter-spacing:0.25em;line-height:1.6;text-transform:uppercase">' . esc_html__( 'About GUTENA', 'gutena' ) . '</h6>
    <!-- /wp:heading --></div>
    <!-- /wp:column -->
