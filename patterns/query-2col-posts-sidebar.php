...
<div class="wp-block-group" style="margin-top:40px;margin-bottom:var(--wp--preset--spacing--medium)"><!-- wp:post-title {"isLink":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|secondary"}}}},"textColor":"secondary"} /-->
