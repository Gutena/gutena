<?php
/**
 * Title:  Background color, 2 column, heading, button, play icon with animation on image and quote.
 * Slug: gutena/sec-2col-text-image-anim-and-quote
...
<h2 class="has-medium-large-font-size"><?php esc_html_e( 'Our mission is to power the future', 'gutena' ) ; ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"fontSize":"normal"} -->
<p class="has-normal-font-size"><?php esc_html_e( 'Far far away, behind the word mountains, far from the countries vokalia and consonantia there live the blind texts. Separated they live in Bookmarksgrove right at the coast', 'gutena' ) ; ?>.</p>
<!-- /wp:paragraph -->
...
<h5 style="font-style:normal;font-weight:400;line-height:1.6">“<?php esc_html_e( "I really recommend this Theme because It's coded well and light", "gutena" ) ; ?>.”</h5>
<!-- /wp:heading -->
