...
<div class="wp-block-query"><!-- wp:post-template {"className":"is-style-gutena-wide-gap-columns"} -->
<!-- wp:group {"style":{"color":{"background":"#015d61"},"spacing":{"padding":{"top":"0px","right":"0px","bottom":"0px","left":"0px"}}}} -->
<div class="wp-block-group  has-background" style="background-color:#015d61;padding-top:0px;padding-right:0px;padding-bottom:0px;padding-left:0px"><!-- wp:cover {"useFeaturedImage":true,"dimRatio":0,"minHeight":534,"contentPosition":"bottom center"} -->
...
<div class="wp-block-group"><!-- wp:group {"style":{"color":{"background":"#e2f2ef"},"spacing":{"padding":{"top":"1px","right":"12px","bottom":"1px","left":"12px"}}},"layout":{"type":"default"}} -->
...
<div class="wp-block-group" style="margin-top:1rem"><!-- wp:post-title {"isLink":true,"style":{"color":{"text":"#21222f"}}} /--></div>
<!-- /wp:group -->
