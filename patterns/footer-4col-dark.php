 ...
 */
?>
<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"5rem","right":"1.25rem","bottom":"5rem","left":"1.25rem"},"blockGap":"23px"},"typography":{"lineHeight":"1.2","fontStyle":"normal","fontWeight":"500"}},"backgroundColor":"secondary","textColor":"white","layout":{"inherit":false,"contentSize":"1100px","type":"constrained"},"fontSize":"small"} -->
...
<h5 class="has-white-color has-text-color"><?php esc_html_e( 'Services', 'gutena' ); ?></h5>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><a href="#"><?php esc_html_e( 'Email Marketing', 'gutena' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"><?php esc_html_e( 'Campaigns', 'gutena' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"><?php esc_html_e( 'Branding', 'gutena' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"><?php esc_html_e( 'Offline', 'gutena' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-column"><!-- wp:group {"style":{"spacing":{"blockGap":"23px"}},"layout":{"type":"constrained","contentSize":"527px"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":5,"textColor":"white"} -->
<h5 class="has-white-color has-text-color"><?php esc_html_e( 'About', 'gutena' ); ?></h5>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><a href="#"><?php esc_html_e( 'Our Story', 'gutena' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"><?php esc_html_e( 'Benefits', 'gutena' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"><?php esc_html_e( 'Team', 'gutena' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"><?php esc_html_e( 'Careers', 'gutena' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-column"><!-- wp:group {"style":{"spacing":{"blockGap":"23px"}},"layout":{"type":"constrained","contentSize":"527px"}} -->
<div class="wp-block-group"><!-- wp:heading {"level":5,"textColor":"white"} -->
<h5 class="has-white-color has-text-color"><?php esc_html_e( 'Help', 'gutena' ); ?></h5>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p><a href="#"><?php esc_html_e( 'FAQs', 'gutena' ); ?></a></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p><a href="#"><?php esc_html_e( 'Contact Us', 'gutena' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
...
<h4 class="has-white-color has-text-color"><?php esc_html_e( 'Follow us on', 'gutena' ); ?></h4>
<!-- /wp:heading -->
