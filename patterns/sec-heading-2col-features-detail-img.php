...
<h2 class="has-text-align-center has-white-color has-text-color has-medium-large-font-size"><?php esc_html_e( 'How our A.I works on your applications', 'gutena' ); ?></h2>
<!-- /wp:heading --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( GUTENA_THEME_URI  ). '/assets/img/icons/check.svg'; ?>" alt="<?php esc_attr_e(  'Check', 'gutena' ); ?>" class="wp-image-30"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<p class="has-white-color has-text-color"><?php esc_html_e( 'Far far away, behind the word mountains, far from the countries Vokalia and there live the blind texts.', 'gutena' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-column"><!-- wp:group {"style":{"spacing":{"blockGap":"0.4rem"}}} -->
<div class="wp-block-group"><!-- wp:heading {"level":4,"textColor":"white"} -->
<h4 class="has-white-color has-text-color"><?php esc_html_e( 'Futuristic Design', 'gutena' ); ?></h4>
<!-- /wp:heading -->
...
<div class="wp-block-group"><!-- wp:group {"style":{"color":{"background":"#ffffff"},"spacing":{"padding":{"top":"41px","bottom":"41px","right":"41px","left":"41px"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group  has-background" style="background-color:#ffffff;padding-top:41px;padding-right:41px;padding-bottom:41px;padding-left:41px"><!-- wp:image {"align":"center","id":947,"sizeSlug":"large","linkDestination":"none"} -->
<figure class="wp-block-image aligncenter size-large"><img src="<?php echo esc_url( GUTENA_THEME_URI  ). '/assets/img/icons/reading.svg'; ?>" alt="<?php esc_attr_e(  'reading', 'gutena' ); ?>" class="wp-image-947"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
